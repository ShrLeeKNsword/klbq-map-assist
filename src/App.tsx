      ...
      <Row
        ...
        <Col span={4}>
          <div
            className="col-content"
            onClick={() => {
              setpenColor('rgba(var(--semi-grey-0), 1)');
            }}>
            <ColorBtn color="rgba(var(--semi-grey-0), 1)" />
          </div>
        </Col>
        <Col span={4}>
          <div
            className="col-content"
            onClick={() => {
              setpenColor('rgba(var(--semi-grey-2), 1)');
            }}>
            <ColorBtn color="rgba(var(--semi-grey-2), 1)" />
          </div>
        </Col>
        <Col span={4}>
          <div
            className="col-content"
            onClick={() => {
              setpenColor('rgba(var(--semi-grey-4), 1)');
            }}>
            <ColorBtn color="rgba(var(--semi-grey-4), 1)" />
          </div>
        </Col>
        <Col span={4}>
          <div
            className="col-content"
            onClick={() => {
              setpenColor('rgba(var(--semi-grey-6), 1)');
            }}>
            <ColorBtn color="rgba(var(--semi-grey-6), 1)" />
          </div>
        </Col>
        <Col span={4}>
          <div
            className="col-content"
            onClick={() => {
              setpenColor('rgba(var(--semi-grey-8), 1)');
            }}>
            <ColorBtn color="rgba(var(--semi-grey-8), 1)" />
          </div>
        </Col>
      </Row>
    </div>
  ...
  return (
    <Layout className="components-layout-demo">
      <Header style={commonStyle}>
        <Title heading={3} style={{ margin: '1rem 0' }}>
          卡拉彼丘地图助手 - {presentMap}
        </Title>
      </Header>
      <Layout>
        <Sider
          style={{ width: '180px', background: 'var(--semi-color-fill-2)' }}>
        ...
        <Content
          ...
          <div
            ...
            <Tooltip content={'画笔'}>
              <div style={canvasToolBtnStyle}>
                <IconEdit size="extra-large" />
              </div>
            </Tooltip>
            <Popover content={article} position={'left'}>
              <div style={canvasToolBtnStyle}>
            ...
            <Tooltip content={'清屏'}>
              <Popconfirm
                ...
                <div
                  ...
                  style={canvasToolBtnStyle}>
                  <IconDelete size="extra-large" />
                </div>
              </Popconfirm>
            </Tooltip>
          </div>
