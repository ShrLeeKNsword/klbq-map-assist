                  ...
                  <Popover
                    ...
                    content={<Card style={{ width: '500px', height: "100%", margin: "0 auto", overflow: "hidden" }}>
                      <div style={{ display: "flex", height: "100%" }}>
                        <div style={{ height: "100%", margin: "0 auto" }}><img draggable="false" src="https://s2.loli.net/2024/10/26/iD1g23pnC9d6hVM.png" style={{ height: "360px", filter: "drop-shadow(0 0 5px rgba(var(--semi-grey-7))" }}></img></div>
