...
const SupportUs = (props: SupportUsPops) => {
    ...
    return (
        <>
            ...
            >
                <div>
                    <div><strong>卡拉彼丘自建房助手</strong>是一款开源软件，</div>
                    <div>因此你可以免费在 GPL-3.0 开源协议的范畴下使用本软件。</div>
                    <div>美术资料与部分UI版权归原作者所有，请咨询对应作者授权！</div>
                    <br />
                    <div>但即便如此，你的赞助也可以给予开发者前进的动力，让这个项目变得更好。</div>
                    <div>无论你使用何种形式赞助，你都可以在<strong>卡拉彼丘自建房助手</strong>的 GitHub 项目主页和网站展示您的信息（个人主页、公司主页、GitHub 资料页等）。</div>
